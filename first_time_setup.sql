...
SELECT pg_catalog.setval('public."Ledgers_id_seq"', 890, true);
...
SELECT pg_catalog.setval('public.lichsuxnk_id_seq', 1468, true);
...
SELECT pg_catalog.setval('public.so_cai_id_seq', 1711, true);
