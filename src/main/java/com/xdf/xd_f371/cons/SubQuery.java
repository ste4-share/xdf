...
public class SubQuery {
    public static String bc_pttk_q(LocalDate sd,LocalDate ed){
        return "select RANK() OVER (PARTITION BY loai ORDER BY tenxd DESC) AS ranks,loai,tenxd,\n" +
                ...
                "where status like 'ACTIVE' and dvi_nhan like 'e916' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_e916 on lxd.id=NHAP_e916.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'e916' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_e916 on lxd.id=XUAT_e916.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'e921' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_e921 on lxd.id=NHAP_e921.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'e921' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_e921 on lxd.id=XUAT_e921.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'e923' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_e923 on lxd.id=NHAP_e923.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'e923' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_e923 on lxd.id=XUAT_e923.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'e927' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_e927 on lxd.id=NHAP_e927.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'e927' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_e927 on lxd.id=XUAT_e927.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'd Nội Bài' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_dnb on lxd.id=NHAP_dnb.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'd Nội Bài' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_dnb on lxd.id=XUAT_dnb.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'd Kiến An' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_dka on lxd.id=NHAP_dka.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'd Kiến An' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_dka on lxd.id=XUAT_dka.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'd Vinh' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_dvi on lxd.id=NHAP_dvi.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'd Vinh' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_dvi on lxd.id=XUAT_dvi.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'd Nà Sản' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_dns on lxd.id=NHAP_dns.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'd Nà Sản' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_dns on lxd.id=XUAT_dns.loaixd_id\n" +
                "left join (select loaixd_id, sum(nhap_nvdx+nhap_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_nhan like 'f Bộ' and loai_phieu like 'NHAP' and from_date between '"+sd+"' and '"+ed+"' group by 1) NHAP_fb on lxd.id=NHAP_fb.loaixd_id\n" +
                "left join (select loaixd_id, sum(xuat_nvdx+xuat_sscd) as tonkho from ledgers l join ledger_details ld on l.id=ld.ledger_id\n" +
                "where status like 'ACTIVE' and dvi_xuat like 'f Bộ' and loai_phieu like 'XUAT' and from_date between '"+sd+"' and '"+ed+"' group by 1) XUAT_fb on lxd.id=XUAT_fb.loaixd_id\n" +
